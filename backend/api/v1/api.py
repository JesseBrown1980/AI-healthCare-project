...
from .endpoints import auth, patients, clinical, system, documents, graph_visualization, calendar, oauth, hl7, consent, security_metrics, privacy
...
api_router.include_router(privacy.router, prefix="/privacy", tags=["Data Privacy"])
api_router.include_router(security_metrics.router, tags=["Security Metrics"])