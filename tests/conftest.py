...
# Sync JWT secrets: auth.py uses DEMO_LOGIN_SECRET, security.py uses DEMO_JWT_SECRET
os.environ["DEMO_JWT_SECRET"] = "test-secret-key-for-mock-tokens-only"
os.environ["DEMO_LOGIN_SECRET"] = "test-secret-key-for-mock-tokens-only"
# Set audience to match test tokens
...
async def test_db():
    ...
    """
    from backend.database.connection import init_database, get_db_context
