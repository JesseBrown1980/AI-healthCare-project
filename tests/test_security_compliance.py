...
class TestAuditLogger:
    ...
    def test_log_event(self, tmp_path):
        ...
        # Mock compliance service for plaintext logging
        mock_compliance = Mock()
        mock_compliance.shred_data.side_effect = lambda data, entity_id: data
        
        logger = AuditLogger(log_dir=str(tmp_path), console_output=False, compliance_service=mock_compliance)
